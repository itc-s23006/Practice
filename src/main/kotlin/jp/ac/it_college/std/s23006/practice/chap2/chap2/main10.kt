...
fun main() {
    ...
    println("----2.10.10----")
    run {
        val users = listOf(1,1,2,3,4,4,5)
    ...
    run {
        val students = listOf(
            jp.ac.it_college.std.s23006.practice.chap2.Student("s30001", "Kuriyama"),
            jp.ac.it_college.std.s23006.practice.chap2.Student("s30002", "Oohira"),
            jp.ac.it_college.std.s23006.practice.chap2.Student("s30003", "Tokunaga"),
            jp.ac.it_college.std.s23006.practice.chap2.Student("s30004", "Kawase"),
            jp.ac.it_college.std.s23006.practice.chap2.Student("s30005", "Kameda")
        )
        students.forEach(::println)

        val studentMap = students.associateBy(jp.ac.it_college.std.s23006.practice.chap2.Student::id)
        studentMap.forEach(::println)
    }

    println("----2.10.12----")
    run {
        val list = listOf("Takahata", "Kotlin", "Java")
